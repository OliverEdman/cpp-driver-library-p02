...
extern "C"
{
    ...
    typedef void (*esp_mqtt_event_cb_t)(void* handler_args, esp_event_base_t base, int32_t event_id,
                                        void* event_data);
...
#define MQTT_EVENT_DATA 3
    ...
    static inline int esp_mqtt_client_subscribe(esp_mqtt_client_handle_t client, const char* topic,
                                                int qos)
    {
        (void)client;
        (void)topic;
