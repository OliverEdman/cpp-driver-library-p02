...
public:
     ...
     *
     *        @note Use imperative comments; prefer "copy" or "copies".
     ...
     */
    virtual bool readMessage(char* topic, std::uint16_t topicMaxLen,
                             char* payload, std::uint16_t payloadMaxLen) noexcept = 0;
};
} // namespace driver::mqtt
