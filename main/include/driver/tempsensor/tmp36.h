 ...
 * 
 *        Implement the temperature interface by converting analog voltage readings
...
public:
   ...
   explicit Tmp36(driver::adc::Interface& adc, std::uint8_t pin) noexcept; 
    ...
    //! @note Imperative comment => "Convert" instead of "Converts".
    /**
...
private:
    //! @note As said before, no brief for one-line comments.
