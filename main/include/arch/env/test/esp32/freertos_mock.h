...
#define pdMS_TO_TICKS(ms) (static_cast<TickType_t>(ms))
    ...
    static inline void vEventGroupDelete(EventGroupHandle_t event_group) { (void)event_group; }
    ...
    static inline EventBits_t xEventGroupWaitBits(EventGroupHandle_t event_group,
                                                  EventBits_t bits_to_wait_for, int clear_on_exit,
                                                  int wait_for_all_bits, TickType_t ticks_to_wait)
    {
        (void)event_group;
        (void)clear_on_exit;
